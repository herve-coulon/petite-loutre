...
export const HABITANT = {
  ...
  lac: { emoji: '🦫', nom: 'Gaspard', role: 'le troqueur du lac', don: 'troc',
    mots: ['Un bon troc, ça se pense avant de se conclure.',
      'Montre-moi tes coquillages — j\'ai toujours de quoi t\'arranger.'] },
