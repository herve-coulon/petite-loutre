...
export const FURS = [
  ...
  { id: 'tresor', bonus: { pv: 1.15, atq: 1.05, luck: 1.25, xp: 1.10 }, icon: '🧰', name: 'Reflet de trésor',
    ...
    map: { B: '#2f7f86', C: '#9fe6dd', D: '#12454c', q: '#215b60' } }
];
